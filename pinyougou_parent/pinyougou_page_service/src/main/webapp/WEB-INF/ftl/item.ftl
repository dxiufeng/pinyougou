...
<body ng-app="pinyougou" ng-controller="itemController" ng-init="number = 1">

<!--页面顶部 开始-->
<#include "head.ftl"/>

<#--定义变量,把数据库中取出的图片赋值给变量并遍历-->
            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
							<#if (imageList?size>0)>
                                <span class="jqzoom"><img jqimg="${imageList[2].url}" src="${imageList[2].url}"
                    ...
                    <div class="summary-wrap">
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    <input autocomplete="off" type="text" ng-model="number" value="1" minnum="1"
                                           class="itxt"/>
